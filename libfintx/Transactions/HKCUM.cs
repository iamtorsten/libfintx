...
namespace libfintx
{
    public static class HKCUM
    {
        ...
        /// Rebooking
        /// </summary>
        public static string Init_HKCUM(int BLZ, string Accountholder, string AccountholderIBAN, string AccountholderBIC, string Receiver,
            string ReceiverIBAN, string ReceiverBIC, decimal Amount, string Usage, string URL, int HBCIVersion, string UserID, string PIN)
        {
            ...
            string segments = "HKCUM:" + SEGNUM.RETVal(3) + ":1+" + AccountholderIBAN + ":" + AccountholderBIC + "+urn?:iso?:std?:iso?:20022?:tech?:xsd?:pain.001.002.03+@@";
