    ...
    public static class pain00100303
    {
        ...
        public static string Create(string Accountholder, string AccountholderIBAN, string AccountholderBIC, string Receiver, string ReceiverIBAN, string ReceiverBIC, decimal Amount, string Usage, DateTime ExecutionDay)
        {
            ...
            string Message = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" +
                "<Document xmlns=\"urn:iso:std:iso:20022:tech:xsd:pain.001.003.03\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"urn:iso:std:iso:20022:tech:xsd:pain.001.003.03 pain.001.001.03.xsd\">" +
                "<CstmrCdtTrfInitn>" +
                "<GrpHdr>" +
                ...
                "</GrpHdr>" +
                "<PmtInf>" +
                "<PmtInfId>" + Program.Buildname + "-" + RndNr.ToString().Replace("-", "") + "</PmtInfId>" +
                "<PmtMtd>TRF</PmtMtd>" +
                "<NbOfTxs>1</NbOfTxs>" +
                "<CtrlSum>" + Amount_ + "</CtrlSum>" +
                "<PmtTpInf>" +
