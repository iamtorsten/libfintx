                    ...
                    switch (i)
                    {
                        case 1:
                            RDH_KEYSTORE.KEY_ENCRYPTION_PRIVATE = Helper.DecodeFrom64EncodingDefault(
                                Helper.Parse_String(RDHXPassport.Decrypt_PBEWithMD5AndDES(line, Password), "<Modulus>", "</Modulus>"));
                            break;
                        case 2:
                            RDH_KEYSTORE.KEY_ENCRYPTION_PRIVATE_XML = RDHXPassport.Decrypt_PBEWithMD5AndDES(line, Password);
                            break;
                        case 3:
                            ...
                            break;
                        case 4:
                            RDH_KEYSTORE.KEY_SIGNING_PRIVATE_XML = RDHXPassport.Decrypt_PBEWithMD5AndDES(line, Password);
                            break;
                        case 5:
